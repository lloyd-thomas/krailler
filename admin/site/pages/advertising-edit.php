...
<form role="form" enctype="multipart/form-data" method="post" autocomplete="off" action="/admin/work-edit">
...
<div class="row">
  ...
  <a href="/admin/work" class="submit btn btn-danger">Cancel</a>
...
<?php if (file_exists($peel."/../img/work/thumbs/".$news[$_GET['edit']]['id']."-1.jpg")) { ?>
      <img src="/img/work/thumbs/<?php echo $news[$_GET['edit']]['id']; ?>-1.jpg?<?php echo rand(1000,9999);?>" style="width: 70px;" />
<?php } ?>
    </div>
...
<form role="form" id="imageupload" enctype="multipart/form-data" method="post" autocomplete="off" action="">
...
<input type="submit" id="imageuploader" class="submit btn btn-success disabled" value="Upload Now" />
</form>
<div id="maincontent"><?php include('system/upload-work.php');?></div>
  </div>
