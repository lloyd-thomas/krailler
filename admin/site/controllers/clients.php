...
if (isset($_POST['save']) && $_POST['save'] == 1) {
 ...
 if (isset($_FILES['image']['type']) && $_FILES['image']['type'] == 'image/jpeg') {
    ...
    move_uploaded_file($_FILES['image']['tmp_name'], $peel."/../img/about/".$_POST['id'].".jpg");
    $resizeObj = new resize($peel."/../img/about/".$_POST['id'].".jpg");
    $resizeObj -> resizeImage(300, 300, 'crop');
    $resizeObj -> saveImage($peel."/../img/about/thumbs/".$_POST['id']."-1.jpg", 80);
    $resizeObj -> resizeImage(1000, 1000, 'portrait');
    $resizeObj -> saveImage($peel."/../img/about/thumbs/".$_POST['id']."-2.jpg", 80);
...
$clients = json_decode($line['content_content']);
