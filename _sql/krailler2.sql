...
CREATE TABLE `peel_incoming` (
  `incoming_id` int(11) NOT NULL AUTO_INCREMENT,
  `incoming_type` varchar(32) DEFAULT NULL,
  `incoming_json` text,
  `incoming_created` datetime DEFAULT NULL,
  `incoming_deleted` int(1) DEFAULT '0',
...
INSERT INTO `peel_incoming` (`incoming_id`, `incoming_type`, `incoming_json`, `incoming_created`, `incoming_deleted`) VALUES (3, 'contact', '{"contact-submit-a":"2443","contact-submit-b":"27d45ff0fcb799745ac40eaa46983061","contactname":"Dan","contactemail":"dl@tedra.net","contacttelephone":"080889898","contactmessage":"dasjdhasdhksajdhs Hello!"}', '2014-03-06 11:47:02', 0);
